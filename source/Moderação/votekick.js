...
const agree    = "512392301037748251";
    ...
    if(!args[0]){
        ...
        .setDescription("<:settings:514924323618816021>**Comando:** s!votekick")
        .setColor("#36393f")
        ...
        .addField("<:st:514922245370413087>Uso:", "\`\`s!votekick <@usuario>\`\`")
        .addField("<:st:514922245370413087>Exemplo:", "\`\`s!votekick @_\`\`"))
        }
            let volte = args[0];
            if (!volte) return;
