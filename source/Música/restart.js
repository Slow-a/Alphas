...
if(!message.member.roles.some(r=>["DJ", "dj"].includes(r.name))) {
    ...
    message.channel.send({
      embed: {
          title: `<a:erro:777261754929381406> Somente membros com o cargo \`DJ\` podem pausar a música`,
          color: 0x36393f,
...
if(!serverQueue) {
    ...
    message.channel.send({
        embed: {
            title: `<a:erro:777261754929381406> Não posso restartar uma radio **AO VIVO**`,
            color: 0x36393e,
