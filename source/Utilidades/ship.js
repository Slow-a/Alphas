...
exports.run = async(client, message, args) => {
    ...
    if (!args[0]) {
        message.channel.send(new Discord.MessageEmbed()
            .setDescription("<a:ferrament:777259483767898122>**Comando:** s!ship")
            .setColor("#36393f")
            ...
            .addField("<:st:832876660578582548>Uso:", "\`\`s!ship <@usuario> <@usuario2>\`\`")
            .addField("<:st:832876660578582548>Exemplo:", "\`\`s!ship @_  @__\`\`"))
    }
    let volte = args[0];
    if (!volte) return;
