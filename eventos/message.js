...
try {
    ...
    if(message.author.bot) return;
        ...
        embed: {
            title: ` **${message.author.tag},** Você não pode **ExecutarComandos/Conversar** em minha DM`,
            color: 0x36393f,
        }
    }).then(msg => { 
        msg.delete(5000)
        ...
        if(servidor) {
            if(servidor.antinvite) {
                ...
                message.channel.send({embed: {
                    ...
                    description: `<a:ferrament:777259483767898122> | ${message.author}, **você nao pode divulgar aqui**`,
                    color: 0xff0000
                }}).then(gg => {
...
database.Comandos.findOne({_id: command}, function(cerro, comando) {
    ...
    var yEmbed = new Discord.MessageEmbed()
        ...
        .setDescription(`<a:ferrament:777259483767898122> | ${message.author}, espere um **pouco** antes de executar outro **comando**`)
            .setColor('#36393f')
    ...
    .setDescription(`<a:ferrament:777259483767898122>| ${message.author}, você está **banido** de usar meus **comandos**`)
        .setColor('#36393f')
